# agents/backup_restore_agent2.py
...
class BackupRestoreAgent2(BackupRestoreBaseAgent):
    agent_backup_dir: str = Field(default_factory=lambda: os.path.join(BACKUP_ROOT, "agent2"))
